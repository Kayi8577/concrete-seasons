...
CS.ITEMS = {
  ...
  wild_greens:   { name:'Wild Greens', type:'forage', sell:12, energy:6, desc:'Tender spring greens gathered with care around the park.' },
  mulberries:    { name:'Mulberries', type:'forage', sell:18, energy:10, desc:'Dark summer berries from a tree the neighborhood keeps secret.' },
  ginkgo_bundle: { name:'Ginkgo Bundle', type:'forage', sell:16, energy:0, desc:'Fan-shaped fall leaves, pressed flat for crafts and gifts.' },
  fallen_twigs:  { name:'Winter Twigs', type:'forage', sell:10, energy:0, desc:'Clean fallen branches, useful for repairs and kindling.' },
  scrap_metal:   { name:'Clean Scrap Metal', type:'material', sell:12, desc:'Sorted and de-rusted. Malik can turn this into something useful.' },
  reclaimed_brick:{ name:'Reclaimed Brick', type:'material', sell:10, desc:'Historic masonry recovered without disturbing the protected ruin.' },
  copper_wire:   { name:'Old Copper Wire', type:'material', sell:25, rare:true, desc:'A careful length from an abandoned conduit. Valuable for irrigation work.' },
...
CS.FARM_UPGRADES = {
  ...
  compost:    { name:'Compost bin', cost:400,
    desc:'Rich soil reliably raises crop quality instead of changing harvest dates.' },
  hydro:      { name:'Hydroponic racks', cost:1500, needs:'irrigation',
    desc:'Twelve more greenhouse beds, self-watering and season-proof. The future smells like basil.' },
  wideCan:    { name:'Wide watering can', cost:300,
    items:{ scrap_metal:3, copper_wire:1 }, skill:{ farming:12 },
    desc:'A broad brass rose: watering one plot splashes its neighbors too.' },
  sharpTools: { name:'Sharpened tool set', cost:220,
    items:{ scrap_metal:4, reclaimed_brick:2 }, skill:{ farming:8 },
